    ...
    <tr>
        <td class="ui-widget-content ui-corner-all ui-state-normal">
            ...
            <div class="fpcm-ui-buttonset fpcm-ui-editor-buttons">
                ...
                <button title="<?php $FPCM_LANG->write('EDITOR_INSERTCOLOR'); ?> (Ctrl + Shift + F)" id="fpcm-editor-html-insertcolor-btn" onclick="return false;"><span class="fa fa-tint"></span></button>
                ...
                <button title="<?php $FPCM_LANG->write('EDITOR_HTML_BUTTONS_LISTUL'); ?> (Ctrl + .)" id="fpcm-editor-html-insertlist-btn"><span class="fa fa-list-ul"></span></button>
                <button title="<?php $FPCM_LANG->write('EDITOR_HTML_BUTTONS_LISTOL'); ?> (Ctrl + #)" id="fpcm-editor-html-insertlistnum-btn"><span class="fa fa-list-ol"></span></button>            
                ...
                <button title="<?php $FPCM_LANG->write('EDITOR_INSERTLINK'); ?>  (Ctrl + L)" id="fpcm-editor-html-insertlink-btn"><span class="fa fa-link"></span></button>
                <button title="<?php $FPCM_LANG->write('EDITOR_INSERTPIC'); ?>  (Ctrl + P)" id="fpcm-editor-html-insertimage-btn"><span class="fa fa-picture-o"></span></button>
                <button title="<?php $FPCM_LANG->write('EDITOR_HTML_BUTTONS_QUOTE'); ?> (Ctrl + Shift + Z)" id="fpcm-editor-html-insertmedia-btn"><span class="fa fa-youtube-play"></span></button>
