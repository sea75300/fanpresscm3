<?php
    ...
    $lang = array(
        ...
        'TEMPLATE_NOTES'                    => '<strong>Notice:</strong><br>'.
                                               '- only use <strong>CSS clases/IDs or inline-"style" values</strong> for styling. HTML-Tags like <em>body, style, etc.</em> create invalid code and could raise problems!<br>'.
        ...
        'TEMPLATE_ARTICLE_SHORTLINK'        => 'Shortlink',
        ...
        'TEMPLATE_COMMMENTFORM_NAMEDESCRIPTION'     => 'Field desctiption "Name"',
        'TEMPLATE_COMMMENTFORM_NAMEFIELD'           => 'Field "Name"',
        'TEMPLATE_COMMMENTFORM_EMAILDESCRIPTION'    => 'Field desctiption "Email"',
        'TEMPLATE_COMMMENTFORM_EMAILFIELD'          => 'Field "E-Mail"',
        'TEMPLATE_COMMMENTFORM_WEBSITEDESCRIPTION'  => 'Field desctiption "Website"',
        'TEMPLATE_COMMMENTFORM_WEBSITEFIELD'        => 'Field "Website"',
        'TEMPLATE_COMMMENTFORM_TEXTFIELD'           => 'Textarea for comment text',
        'TEMPLATE_COMMMENTFORM_SMILEYSDESCRIPTION'  => 'Desctiption "Smileys"',
