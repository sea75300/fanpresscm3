<?php
    ...
    $lang = array(
        ...
        'SAVE_FAILED_USER_DISBALE'      => 'Unable to disable the user!',
        'SAVE_FAILED_USER_DISBALE_OWN'  => 'You cannot disable your own account!',
        'SAVE_FAILED_USER_DISBALE_LAST' => 'Unable to disable the last user!',
        ...
        'LOAD_FAILED_ARTICLE'           => 'The requested article was no found.',
        'LOAD_FAILED_COMMENT'           => 'The requested comment was no found.',
        'LOAD_FAILED_USER'              => 'The requested user was no found.',
        'LOAD_FAILED_ROLL'              => 'The requested user roll was no found.',
        'LOAD_FAILED_CATEGORY'          => 'The requested category was no found.',
        
        'UPDATE_VERSIONCHECK_NEW'       => 'A new version of FanPress CM is available! To update your installation <a class="fpcm-ui-button fpcm-start-update fpcm-ui-actions-genreal fpcm-loader" href="{{versionlink}}">click here</a>.',
        'UPDATE_VERSIONCHECK_CURRENT'   => 'Your version of FanPress CM is <strong>up to date</strong>!<br><span class="fpcm-small-text">{{releasmsg}} ({{releaseinfo}})</span>',
        ...
        'UPDATE_MODULECHECK_FAILED'      => 'Automatic update check for modules failed!',
        ...
        'PACKAGES_SUCCESS_DOWNLOAD'     => 'Download of package file has been successful.',
        'PACKAGES_SUCCESS_EXTRACT'      => 'Extractig package file has been successful.',
        'PACKAGES_SUCCESS_COPY'         => 'Copy of package file content has been successful.',
        'PACKAGES_SUCCESS_ADDITIONAL'   => '<span class="fa fa-check-square fpcm-ui-booltext-yes"></span> Execution of additional package steps has been successful!',
        
        'PACKAGES_RUN_DOWNLOAD'         => '<span class="fa fa-cloud-download fpcm-ui-booltext-yes"></span> Start download of package <i>{{pkglink}}</i>...',
        ...
        'MODULES_SUCCESS_INSTALL'       => '<span class="fa fa-check-square fpcm-ui-booltext-yes"></span> Selected modules were installed.',
        'MODULES_SUCCESS_UNINSTALL'     => 'Selected modules were uninstalled.',
        'MODULES_SUCCESS_UPDATE'        => '<span class="fa fa-check-square fpcm-ui-booltext-yes"></span> The module has been updated successfully.',
        
        'MODULES_FAILED_ENABLE'         => 'Unable to enable selected modules.',
        'MODULES_FAILED_DISABLE'        => 'Unable to disable selected modules.',
        'MODULES_FAILED_INSTALL'        => '<span class="fa fa-minus-square fpcm-ui-booltext-no"></span> Unable to install selected modules.',
