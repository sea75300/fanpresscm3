<?php
    ...
    $lang = array(
        ...
        'SAVE_SUCCESS_ARTICLE'          => 'Der Artikel wurden gespeichert!',
        'SAVE_SUCCESS_ARTICLE_APPROVAL' => 'Der Artikel wurden gespeichert, muss aber noch genehmigt freigeschalten werden!',
        'SAVE_SUCCESS_ARTICLEPINN'      => 'Die Artikel wurden (ab)gepinnt!',
        'SAVE_SUCCESS_ARTICLEAPPROVAL'  => 'Die Artikel-Freigabe wurde geändert!',
        'SAVE_SUCCESS_ARTICLEARCHIVE'   => 'Die Artikel wurden archiviert!',
        ...
        'SAVE_SUCCESS_ARTICLECOMMENTS'  => 'Die Kommentare wurden für die Artikel (de)aktiviert!',
        'SAVE_SUCCESS_ARTICLEREVRESTORE'=> 'Die Revision wurde wiederhergestellt!',
        'SAVE_SUCCESS_COMMENT'          => 'Der Kommentar wurden gespeichert!',
        ...
        'SAVE_FAILED_USER_DISBALE'      => 'Der Benutzer konnte nicht deaktiviert werden!',
        'SAVE_FAILED_USER_DISBALE_OWN'  => 'Du kannst deinen eigenen Account nicht deaktivieren!',
        'SAVE_FAILED_USER_DISBALE_LAST' => 'Der letzte Benutzer kann nicht deaktiviert werden!',
        ...
        'SAVE_FAILED_IPADDRESS'         => 'Die IP-Adresse konnten nicht gesperrt werden!',
        ...
        'DELETE_SUCCESS_IPADDRESS'      => 'Die IP-Adresse wurden gelöscht!',
        ...
        'PACKAGES_SUCCESS_DOWNLOAD'     => 'Das Herunterladen der Paket-Datei war erfolgreich.',
        'PACKAGES_SUCCESS_EXTRACT'      => 'Das Entpacken der Paket-Datei war erfolgreich.',
        'PACKAGES_SUCCESS_COPY'         => 'Der Inhalt der Paket-Datei konnte erfolgreich an sein Ziel kopiert werden.',
        'PACKAGES_SUCCESS_ADDITIONAL'   => '<span class="fa fa-check-square fpcm-ui-booltext-yes"></span> Das Ausführen der abschließenden Paket-Aktionen war erfolgreich!',
        
        'PACKAGES_RUN_DOWNLOAD'         => '<span class="fa fa-cloud-download fpcm-ui-booltext-yes"></span> Starte Download von Paket <i>{{pkglink}}</i>...',
        'PACKAGES_RUN_EXTRACT'          => '<span class="fa fa-file-archive-o fpcm-ui-booltext-yes"></span> Paket wird entpackt...',
        'PACKAGES_RUN_COPY'             => '<span class="fa fa-random fpcm-ui-booltext-yes"></span> Paket-Inhalt wird an Ziel kopiert...',
        'PACKAGES_RUN_ADDITIONAL'       => '<span class="fa fa-refresh fpcm-ui-booltext-yes"></span> Führe abschließende Paket-Aktionen durch...',
        
        'UPDATES_SUCCESS'               => 'Das Update wurde erfolgreich durchgeführt!',
        'UPDATES_FAILED'                => '<span class="fa fa-minus-square fpcm-ui-booltext-no"></span> Das Update konnte nicht erfolgreich durchgeführt werden!',
        ...
        'MODULES_SUCCESS_INSTALL'       => '<span class="fa fa-check-square fpcm-ui-booltext-yes"></span> Das ausgewählte Module wurde installiert.',
        'MODULES_SUCCESS_UNINSTALL'     => 'Die ausgewählten Module wurden deinstalliert.',
        'MODULES_SUCCESS_UPDATE'        => '<span class="fa fa-check-square fpcm-ui-booltext-yes"></span> Das ausgewählte Modul wurde aktualisiert.',
        ...
        'MODULES_FAILED_INSTALL'        => '<span class="fa fa-minus-square fpcm-ui-booltext-no"></span> Das ausgewählte Modul konnte nicht installiert werden.',
