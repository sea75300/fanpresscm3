<?php
    ...
    class comment extends \fpcm\model\abstracts\model {
         ...
         */
        const COMMENT_TEXT_HTMLTAGS_FORM = '<b>, <strong>, <i>, <em>, <u>, <a href="">, <blockquote>, <p>, <span>, <div>, <ul>, <ol>, <li>';
        
        /**
         * Erlaubte HTML-Tags in einem Kommentar, interne Prüfung
         */
        const COMMENT_TEXT_HTMLTAGS_CHECK = '<b><strong><i><em><u><a><blockquote><p><span><div><ul><ol><li>';
