<?php
    ...
    $installfile   = 'https://updates.nobody-knows.org/fanpress/system/packages/fanpress3.4.4_full.zip';
    
    $signature = (file_exists(__DIR__.'/packages/fanpress_update_version3.4.4.zip')
               ? '$sig$'.md5_file(__DIR__.'/packages/fanpress_update_version3.4.4.zip').'_'
                        .sha1_file(__DIR__.'/packages/fanpress_update_version3.4.4.zip').'$sig$'
               : '');
    ...
    $versions = array(
        'default' => array(
            ...
            'notice'    => 'https://nobody-knows.org/fanpress-cm-3-4-4-veroeffentlicht/',
            'signature' => $signature,
            'phpversion'    => '5.4.0'
        ),
