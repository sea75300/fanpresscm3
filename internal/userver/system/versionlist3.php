<?php
    ...
    $installfile    = 'https://github.com/sea75300/fanpresscm3/releases/download/v3.7.0/fanpress3.7.0_full.zip';
    
    $signature     = (file_exists(__DIR__.'/packages/fanpress_update_version3.7.0.zip')
                    ? '$sig$'.md5_file(__DIR__.'/packages/fanpress_update_version3.7.0.zip').'_'.sha1_file(__DIR__.'/packages/fanpress_update_version3.7.0.zip').'$sig$'
                    : '');

    $versions = array(
        'default' => array(
            'newversion'    => '3.7.0',
            'file'      => 'https://updates.nobody-knows.org/fanpress/system/packages/fanpress_update_version3.7.0.zip',
            'force'     => 0,
