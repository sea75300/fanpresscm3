<?php
    ...
    $installfile   = 'https://github.com/sea75300/fanpresscm3/releases/download/v3.6.1/fanpress3.6.1_full.zip';
    
    $signature = (file_exists(__DIR__.'/packages/fanpress_update_version3.6.1.zip')
               ? '$sig$'.md5_file(__DIR__.'/packages/fanpress_update_version3.6.1.zip').'_'
                        .sha1_file(__DIR__.'/packages/fanpress_update_version3.6.1.zip').'$sig$'
               : '');

    $versions = array(
        'default' => array(
            'newversion'    => '3.6.1',
            'file'      => 'https://updates.nobody-knows.org/fanpress/system/packages/fanpress_update_version3.6.1.zip',
            'force'     => 0,
