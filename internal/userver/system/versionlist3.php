<?php
    ...
    $installfile   = 'https://updates.nobody-knows.org/fanpress/system/packages/fanpress3.5.1-pl1_full.zip';
    
    $signature = (file_exists(__DIR__.'/packages/fanpress_update_version3.5.1-pl1.zip')
               ? '$sig$'.md5_file(__DIR__.'/packages/fanpress_update_version3.5.1-pl1.zip').'_'
                        .sha1_file(__DIR__.'/packages/fanpress_update_version3.5.1-pl1.zip').'$sig$'
               : '');

    $versions = array(
        'default' => array(
            'newversion'    => '3.5.1-pl1',
            'file'      => 'https://updates.nobody-knows.org/fanpress/system/packages/fanpress_update_version3.5.1-pl1.zip',
            'force'     => 0,
