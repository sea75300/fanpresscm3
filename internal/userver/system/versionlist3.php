<?php
    ...
    $signature = (file_exists(__DIR__.'/packages/fanpress_update_version3.1.0.zip')
               ? '$sig$'.md5_file(__DIR__.'/packages/fanpress_update_version3.1.0.zip').'_'
                        .sha1_file(__DIR__.'/packages/fanpress_update_version3.1.0.zip').'$sig$'
               : '');
